    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            Populater(ints);
            Console.WriteLine($"New Capacity: {ints.Capacity}");
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
            ...
            {
                Console.WriteLine($"The number {searchNumber} can't make it to the phone right now. Please try again later.");
            }
        }
